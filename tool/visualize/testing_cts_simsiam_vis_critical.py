...
def test(args, bags_list, milnet):
    ...
    for i in range(0, num_bags):
        ...
        with torch.no_grad():
            ...
            bag_prediction, A, _, idx = milnet.b_classifier(bag_feats, ins_classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--bag_path', type=str, default='WSI/weakly64_single/single/1')
    parser.add_argument('--map_path', type=str, default='WSI/weakly64_single/output')
    ...
    b_classifier = mil.BClassifier(input_size=args.feats_size, output_class=args.num_classes, n_critical=args.n_critical).cuda()
