...
def test(args, bags_list, milnet):
    ...
    for i in range(0, num_bags):
        ...
        with torch.no_grad():
            ...
            #colored_tiles = np.matmul(classes_arr, colors[0][None, :])
