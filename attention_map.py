...
if __name__ == '__main__':
    ...
    layer = None
    if args.norm == 'b':
        layer = models.resnet50(pretrained=True, norm_layer=nn.BatchNorm2d)
    else:
        layer = models.resnet18(pretrained=False, norm_layer=nn.InstanceNorm2d)
    ...
    if args.embedder_weights == 'ImageNet':
        ...
        if args.backbone == 'resnet50':
            resnet = models.resnet50(pretrained=True, layer)
        else:
            resnet = models.resnet18(pretrained=False, layer)
