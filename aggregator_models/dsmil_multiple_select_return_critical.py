...
class FCLayer(nn.Module):
    def __init__(self, in_size, out_size=1):
        ...
        self.fc =  nn.Sequential(nn.Linear(in_size, 512), nn.Linear(512, 128), nn.Linear(128, out_size))
...
class IClassifier(nn.Module):
    def __init__(self, feature_extractor, feature_size, output_class):
        ...
        self.fc =  nn.Sequential(nn.Linear(feature_size, 512), nn.Linear(512, 128), nn.Linear(128, output_class))
...
class BClassifier(nn.Module):
    ...
    def forward(self, feats, c): # N x K, N x C
        ...
        return C, A, B, m_indices[:self.n_critical] 
...
class MILNet(nn.Module):
    ...
    def forward(self, x):
        ...
        prediction_bag, A, B, indices = self.b_classifier(feats, classes)
        
        return classes, prediction_bag, A, B, indices
